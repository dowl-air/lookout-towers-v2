...
import {
    ...
    HOMEPAGE_OPEN_GRAPH_IMAGE_PATH,
    HOMEPAGE_SHARE_IMAGE_ALT,
    HOMEPAGE_TITLE,
...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: `${HOMEPAGE_TITLE} | Rozhlednový svět`,
        description: HOMEPAGE_DESCRIPTION,
        ...
        images: [
            {
                url: HOMEPAGE_OPEN_GRAPH_IMAGE_PATH,
                width: 1200,
                height: 630,
                alt: HOMEPAGE_SHARE_IMAGE_ALT,
            },
        ],
    },
    twitter: {
        ...
        images: [
            {
                url: HOMEPAGE_TWITTER_IMAGE_PATH,
                alt: HOMEPAGE_SHARE_IMAGE_ALT,
            },
        ],
    },
