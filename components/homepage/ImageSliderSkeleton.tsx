export default function ImageSliderSkeleton() {
    return (
        <div className="flex gap-4 justify-center items-center mt-5 max-w-7xl mx-auto overflow-hidden">
            {[...Array(7)].map((item, index) => (
                <div
                    key={index}
                    className="card card-compact min-w-44 lg:min-w-60 mx-auto transition-transform duration-200 cursor-pointer hover:scale-105 "
                >
